...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center bg-navy relative overflow-hidden">
      ...
      <div className="max-w-container mx-auto px-6 pt-24 pb-20 relative">
        <motion.div
          initial="hidden"
          animate="visible"
          className="max-w-2xl"
        >
          ...
          <motion.h1
            variants={fadeUp}
            custom={0.1}
            className="text-[52px] sm:text-[64px] font-bold text-white leading-[1.05] tracking-tight mb-4"
          >
            Joseph Raphael
          </motion.h1>
          ...
          >
            ...
            <a
              href="https://github.com/josephraphael"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-white/20 text-white/60 text-[13px] font-semibold px-5 py-2.5 rounded-md hover:bg-white/10 hover:text-white transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
